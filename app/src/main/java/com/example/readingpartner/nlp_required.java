...
public class nlp_required extends AppCompatActivity {
    ...
    private String fetch_words(String text) {
        ...
        try {
            ...
            lem = am2.open("en-lemmatizer.bin");
            lemmatizer = new SimpleLemmatizer(lem);
        ...
        protected ArrayList<ArrayList<String>> doInBackground(ArrayList<String>... arrayLists) {
            ...
            for(int i=0;i<input_words.size();i++) {
                ...
                if(c.moveToFirst()) {
                    ...
                    Cursor c1 = databaseHelper.getMeaningNoun(input_words.get(i));
                    if(c1.moveToFirst()) {
                        String definitions1 = c1.getString(c1.getColumnIndex("definition"));
                        String input_word = c1.getString(c1.getColumnIndex("word"));
                        words.add(input_word);
                        definitions.add(definitions1);
                    }
                }
